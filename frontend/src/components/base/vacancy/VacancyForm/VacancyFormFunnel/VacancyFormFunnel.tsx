              ...
              render={({ field, fieldState }) => (
                ...
                >
                  <span className="flex items-center gap-1">
                    ...
                    <Tooltip
                      content="На этом этапе соискателю будет предложено выбрать свободное время для встречи в вашем расписании. Видеовстреча автоматически создастся в Zoom. Ссылка сохранится в отклике и в вашем календаре."
